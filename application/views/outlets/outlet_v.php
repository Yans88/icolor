...
<div class="modal fade" role="dialog" id="confirm_del">
 ...
 <div class="box-header">
    <a href="<?php echo site_url('outlet/add');?>"><button class="btn btn-success add_news"><i class="fa fa-plus"></i> Add</button></a>
</div>
<div class="box-body">
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		<thead><tr>
            ...
            <th style="text-align:center; width:20%">Nama Store</th>		
			...
			<?php 
				...
				if(!empty($faq)){		
					foreach($faq as $f){	
						...
						echo '<td>'.$f['nama'].'</td>';						
						echo '<td>'.$f['nama_city'].' - '.$f['nama_provinsi'].'</td>';						
						echo '<td>'.$f['deskripsi'].' '.$koordinat.'</td>';
						echo '<td align="center" style="vertical-align: middle;">		
			
			<a href="'.site_url('outlet/add/'.$f['id_op']).'" title="Edit"><button class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit</button></a>
