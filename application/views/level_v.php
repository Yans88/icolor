...
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		...
		<tbody>
			...
			if($l['id'] > 1){
				echo ' <a href="#" title="Delete Level" id="'.$l['id'].'" class="del_level"><button class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> Delete</button></a>';
			}else{
				echo ' <button class="btn btn-xs btn-danger" disabled><i class="fa fa-trash-o"></i> Delete</button>';
			}
