            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding-bottom:2px;">
				...
				<div class="form-group">
                  <label>Title</label><span class="label label-danger pull-right judul_error"></span>
                  <input type="text" class="form-control" name="judul" id="judul" value="" placeholder="Title" autocomplete="off" />
                ...
                <div class="form-group">
                  <div class="fileupload-new thumbnail" style="width: 200px; height: 158px; margin-bottom:5px;">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="exampleInputPassword1">Description</label><span class="label label-danger pull-right ket_error"></span>
                  <textarea class="form-control" name="ket" id="ket" placeholder="Description" rows=13></textarea></textarea>
					</div>
				</div>
				</div>
			...
			<?php 
				...
				if(!empty($category)){		
					foreach($category as $c){	
						...
						$info = $c['id_banner'].'Þ'.$path.'Þ'.$c['title'].'Þ'.$c['ket'];
						echo '<tr>';
						echo '<td align="center">'.$i++.'.</td>';
						echo '<td>'.$c['title'].'.</td>';
						echo '<td>'.$c['ket'].'.</td>';
						
						echo '<td class="first" align="center"><a class="" href="'.$path.'" title="Banner"><img width="200" height="180" src="'.$path.'"></a></td>';
						
						echo '<td align="center" style="vertical-align: middle;">		
			
			<button class="btn btn-xs btn-success edit_category" id="'.$info.'" title="Edit"><i class="fa fa-edit"></i> Edit</button>
				<button title="Delete" id="'.$c['id_banner'].'" class="btn btn-xs btn-danger del_category" style="margin-top:3px;"><i class="fa fa-trash-o"></i> Delete</button>		
						</td>';
						echo '</tr>';
					}
				}
