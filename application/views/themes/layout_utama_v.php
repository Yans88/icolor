...
<head>
	<meta charset="UTF-8">
	<title><?php echo $judul_browser;?> - iColor</title>
...
<body class="skin-blue">
	...
	<header class="header">
		<a href="<?php echo site_url();?>" class="logo" style="text-align:center;">
			...
			<div><img width=40 height=40 src="<?php echo base_url('assets/logo_putih_icolor.png');?>" /></div>
		</a>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span><?php echo $this->session->userdata('u_name');?> <i class="caret"></i></span>
						</a>
