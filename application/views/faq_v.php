...
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		...
		<tbody>
			...
			<button class="btn btn-xs btn-success edit_news" id="'.$info.'" title="Edit"><i class="fa fa-edit"></i> Edit</button>
...
$('.edit_news').click(function(){
	...
	$('#id_faq').val(dt[0]);
	var id = $('#id_faq').val();
	var url = '<?php echo site_url('faq/get_faq');?>';
	$.ajax({
		data : {id : id},
		url : url,
		type : "POST",
		success:function(response){
			...
			CKEDITOR.instances['question'].setData(res.question);
			CKEDITOR.instances['answer'].setData(res.answer);
