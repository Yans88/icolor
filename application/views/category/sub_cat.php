...
<div class="modal fade" role="dialog" id="frm_category">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding-bottom:2px;">
				...
				<div class="form-group">
                  ...
                  <input type="text" class="form-control" name="sub_category" id="sub_category" value="" placeholder="Type" autocomplete="off" />
				...
				<div class="col-md-4">
					...
					<input type="text" class="form-control input_number" name="priority" id="priority" value="" placeholder="Priority" autocomplete="off" />
				</div>
				</div>
              </form>
 ...
 <div class="box-header">
    <a href="#"><button class="btn btn-success add_category"><i class="fa fa-plus"></i> Add Type</button></a>
</div>
<div class="box-body">
			...
			<?php 
				...
				if(!empty($sub_category)){		
					foreach($sub_category as $s){	
						...
						$info = $s['id_sub'].'Þ'.$s['id_kategori'].'Þ'.htmlspecialchars($s['nama_sub']).'Þ'.$path.'Þ'.(int)$s['priority'];
						echo '<tr>';
						...
						echo '<td align="center">'.(int)$s['priority'].'</td>';
