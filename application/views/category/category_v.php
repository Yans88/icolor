			...
			<?php 
				...
				if(!empty($category)){		
					foreach($category as $c){	
						...
						$info = $c['id_kategori'].'Þ'.htmlspecialchars($c['nama_kategori']).'Þ'.$path;
						echo '<tr>';
						...
						$view_sub = site_url('category/tipe/'.$c['id_kategori']);
						echo '<td align="center" style="vertical-align: middle;">		
			
			<a href="'.$view_sub.'" title="List Type"><button class="btn btn-xs btn-info"><i class="fa fa-list"></i> List Type</button></a>
