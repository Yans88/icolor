<style type="text/css">
	...
	.tools > .fa, .box .todo-list > li .tools > .glyphicon, .box .todo-list > li .tools > .ion {
    margin-right: 5px;
    cursor: pointer;
}
</style>
...
<div class="modal fade" role="dialog" id="frm_user">
 ...
 <div class="box-header">
    <a href="<?php echo site_url('user/add');?>"><button class="btn btn-success"><i class="fa fa-plus"></i> Add User</button></a>
</div>
<div class="box-body">
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		<thead><tr>
			...
			<th style="text-align:center; width:17%">Store</th>
			...
			<?php 
				...
				if(!empty($users)){
					foreach($users as $u){	
						...
						echo '<td style="vertical-align: middle;">'.$u['store_name'].'</td>';
						
						
						echo '<td style="vertical-align: middle;">'.$u['level_name'].'</td>';
						echo '<td align="center" style="vertical-align: middle;">'.$status.'</td>';
						echo '<td align="center" style="vertical-align: middle;">
			<a href="'.site_url('user/add/'.$u['operator_id']).'" title="Edit"><button class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit</button></a>
